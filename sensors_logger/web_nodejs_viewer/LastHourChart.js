...
function initChart(Chart)
{
	...
	Chart.PLine = svg.append("path")
			.attr("class", "line")
			.attr("d", Chart.valueline(Chart.data));
...
//----------Here Chart used as Global var -> should be passed as argument
function d3_SetChartValues(Times,Values)
{
	...
	Chart.PLine.attr("d", Chart.valueline(Chart.data));	
}
